...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 bg-[#020617]/90 backdrop-blur-md border-b border-blue-900/30 z-50 transition-all duration-300">
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-40 bg-[#020617] pt-28 px-6 pb-8 flex flex-col lg:hidden overflow-y-auto"
          >
