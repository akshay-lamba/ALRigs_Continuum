...
export default function MARKETIndustriesWeAreIn() {
  ...
  return (
    <div className="pt-16 pb-12 px-6 max-w-5xl mx-auto min-h-screen space-y-10">
      ...
      <div>
        <h1 className="text-3xl md:text-5xl font-black mb-6 tracking-tighter gradient-text-blue leading-none">Industries We Are In</h1>
        <p className="text-xl font-medium text-slate-400 leading-relaxed mb-12">
          Headline content for Industries We Are In. Sublines and specific paragraphs will go here to explain the core concept concisely without fluff.
        </p>
      </div>
