          ...
          >
            <div className="relative aspect-video rounded-[2rem] md:rounded-[3rem] overflow-hidden border border-white/10 bg-black shadow-[0_0_100px_-20px_rgba(59,130,246,0.2)]">
              <iframe 
                width="100%" 
                height="100%" 
                src="https://www.youtube.com/embed/videoseries?list=PL4_49j8YRffwPXMplAHDoDXOAZvrdgG5g" 
                title="ALRigs Business AI Showcase" 
                frameBorder="0" 
        ...
        <div className="w-full relative bg-neutral-900 py-32 px-8 flex flex-col items-center justify-center text-center border-t border-white/5 overflow-hidden group/download">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <p className="text-[10px] font-black text-blue-500/60 tracking-[0.5em] mb-12">
              Business AI Enterprise Framework
            </p>
            
            <a 
              href="https://b2006858-57c1-480a-9730-8e9f2057acb9.usrfiles.com/ugd/b20068_fce246f32dae405c8bddcc95e9c4b1cf.pdf"
              target="_blank"
