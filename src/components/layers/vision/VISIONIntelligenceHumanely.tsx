...
export default function VISIONIntelligenceHumanely() {
  ...
  return (
    <div className="pt-32 pb-24 px-6 max-w-5xl mx-auto min-h-screen space-y-24">
      ...
      <div>
        <h1 className="text-3xl md:text-5xl font-black mb-6 tracking-tighter gradient-text-blue leading-none">Intelligence Humanely</h1>
        <p className="text-xl font-medium text-slate-400 leading-relaxed mb-12">
          Headline content for Intelligence Humanely. Sublines and specific paragraphs will go here to explain the core concept concisely without fluff.
        </p>
      </div>
