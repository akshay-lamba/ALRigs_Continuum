...
export default function PEOPLERunningaBusiness() {
  ...
  return (
    <div className="pt-32 pb-20 px-6 max-w-5xl mx-auto min-h-screen space-y-16">
      ...
      <div>
        <h1 className="text-4xl md:text-5xl font-black text-slate-400 mb-6 tracking-tighter">I Own a Business</h1>
        <p className="text-xl font-medium text-slate-400 leading-relaxed mb-12">
          Headline content for Running a Business. Sublines and specific paragraphs will go here to explain the core concept concisely without fluff.
        </p>
      </div>
