...
export default function PEOPLETechLeader() {
    ...
    <div className="bg-transparent min-h-screen font-sans overflow-x-hidden pt-12 pb-10">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto flex flex-col px-6">
        ...
        <div className="w-full flex flex-col rounded-[2rem] overflow-hidden border border-white/10 shadow-2xl bg-black">
          ...
          >
            <img 
              src="https://static.wixstatic.com/media/b20068_b64347f2e3f24d0b9ed87da2436f6af6~mv2.jpeg" 
              alt="Tech Leader Section 1" 
          ...
          >
            <img 
              src="https://static.wixstatic.com/media/b20068_fa7bfad1ece6444c85cd1d2a2ba93877~mv2.jpeg" 
              alt="Tech Leader Section 2" 
              className="w-full h-auto object-cover transform group-hover:scale-[1.01] transition-transform duration-1000"
              referrerPolicy="no-referrer"
            />
          </motion.div>
          ...
          >
            <img 
              src="https://static.wixstatic.com/media/b20068_36051c87c78e4c138047793eb171a77c~mv2.jpeg" 
              alt="Tech Leader Section 3" 
              className="w-full h-auto object-cover transform group-hover:scale-[1.01] transition-transform duration-1000"
              referrerPolicy="no-referrer"
            />
          </motion.div>
          ...
          <div className="w-full relative bg-neutral-900 py-20 px-8 flex flex-col items-center justify-center text-center border-t border-white/10 overflow-hidden group/download">
            ...
            <motion.div 
              ...
              className="absolute bottom-0 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-blue-600 to-transparent"
            />
            ...
            <div className="relative z-10 flex flex-col items-center">
              <h3 className="text-3xl md:text-5xl font-black text-white tracking-tighter uppercase mb-2 group-hover/download:text-blue-500 transition-colors duration-700">
                Download architecture strategy.
              </h3>
              <p className="text-[10px] font-black text-blue-500/60 uppercase tracking-[0.5em] mb-12">
                Tech Leader AI Infrastructure Blueprint
              </p>
              
              <button 
                onClick={() => window.open('https://b2006858-57c1-480a-9730-8e9f2057acb9.usrfiles.com/ugd/b20068_9ece97ee2d434636af36993155912aa2.pdf', '_blank')}
              ...
              >
                <span className="relative z-10">Access Blueprint</span>
