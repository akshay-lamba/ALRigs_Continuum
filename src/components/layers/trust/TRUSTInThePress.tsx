...
export default function TRUSTInThePress() {
  ...
  return (
    <div className="pt-32 pb-20 px-6 max-w-5xl mx-auto min-h-screen space-y-16">
      ...
      >
        <ArrowLeft className="w-4 h-4 mr-2" /> Back to TRUST
      </button>

      <div>
        <h1 className="text-4xl md:text-5xl font-black text-slate-400 mb-6 tracking-tighter">In The Press</h1>
        <p className="text-xl font-medium text-slate-400 leading-relaxed mb-12">
          Headline content for In The Press. Sublines and specific paragraphs will go here to explain the core concept concisely without fluff.
        </p>
      </div>
