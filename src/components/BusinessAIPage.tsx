    ...
    <div className="pt-32 pb-20 bg-transparent min-h-screen flex flex-col relative overflow-hidden">
      ...
      <div className="w-full max-w-5xl mx-auto px-6 mb-16 relative z-10">
        <div className="p-2 md:p-4 rounded-[2rem] bg-gradient-to-b from-[#0f172a]/60 to-[#020617]/60 backdrop-blur-xl border border-blue-900/30 shadow-2xl relative w-full flex items-center justify-center">
            <img 
              src="https://static.wixstatic.com/media/b20068_bae7112cc1e14c41bcc8bd7bd259ea91~mv2.jpeg" 
      ...
      <div className="w-full max-w-4xl mx-auto px-6 relative z-10 space-y-16">
        ...
        <div className="text-center">
          ...
          <p className="text-lg md:text-xl font-medium tracking-wide text-slate-400 leading-relaxed">
            Sovereign Margin Expansion across markets. Scale your intelligence securely across multiple divisions and geographies, maintaining strict data boundaries and operational sovereignty.
          </p>
        </div>
          ...
          {[
            {
              ...
              description: "Maintain absolute control over your global neural network, ensuring intelligence doesn't bleed to competitors."
            },
            {
              title: "Cross-Division Scale",
              description: "Deploy discrete AI systems for different business units while maintaining unified central governance."
            },
            {
              title: "Cost Destruction at Scale",
              description: "Eliminate vast swathes of recurring operational expenditure across all integrated markets."
            },
            {
              title: "Enterprise Ecosystem Integration",
              description: "Deep, secure connections to your existing ERP, CRM, and proprietary databases natively."
            }
          ].map((feature, i) => (
            <motion.div
              key={i}
